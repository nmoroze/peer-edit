...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.total_points'
        db.add_column(u'edit_author', 'total_points',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.total_points'
        db.delete_column(u'edit_author', 'total_points')
    ...
    models = {
        ...
        u'edit.author': {
            ...
            'total_points': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
